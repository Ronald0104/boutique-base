...
class Cliente extends CI_Controller {
    ...
    public function listar() {    
        ...
        $this->datos["page"] = "customers/list-customers";
        $this->datos["js"] = ['multiselect/bootstrap-multiselect.min', 'customer'];
        $this->datos["css"] = ['multiselect/bootstrap-multiselect.min'];
        $this->datos["cliente"] = $clientes;
        // $datos = [
