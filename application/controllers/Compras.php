...
class Compras extends CI_Controller {
    ...
    public function index() {
        ...
        if (in_array($usuario['rol_id'], ["1","2"])){
            ...
            $this->datos["page"] = "layouts/message";
            $this->datos["mensaje"] = "NO TIENE AUTORIZACIÓN PARA ACCEDER A ESTE SITIO";
    ...
    function listar() {
        ...
        //     'tiendaId' => $tiendaId
        // ];
        $this->datos["page"] = "compras/list-purchases";
        $this->datos["js"] = ['purchase.js?v1.0'];
        $this->datos["tiendas"] = $tiendas;
        $this->datos["tipoGasto"] = $tipoGasto;
        $this->datos["fechaDesde"] = $fechaDesde->format('d/m/Y');
        $this->datos["fechaHasta"] = $fechaHasta->format('d/m/Y');
        $this->load->view('init', $this->datos);
    }
