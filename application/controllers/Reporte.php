...
class Reporte extends CI_Controller {
    ...
    public function reporteFlujoCaja() {
        ...
        if (!in_array($usuario['rol_id'], ["1","2"])){
            ...
            // ];   
            $this->datos["page"] = "/reporte/reporte-flujo-caja";
            $this->datos["js"] = ['rpt-flujo-caja.js'];
            $this->datos["fechaDesde"] = $fechaDesde;
            $this->datos["fechaHasta"] = $fechaHasta;
            $this->datos["listaTiendas"] = $tiendas;
            $this->datos["tiendaUsuario"] = $tiendaUsuario;
    ...
    public function reportePendienteDevolucion() {
        ...
        $this->datos["page"] = "/reporte/reporte-pendiente-devolucion";
        $this->datos["js"] = ['rpt-pend-dev.js'];
        $this->datos["listaTiendas"] = $tiendas;
        $this->datos["tiendaUsuario"] = $tiendaUsuario;
        $this->load->view('init', $this->datos);
    }
    ...
    public function reporteReservas() {
        ...
        $this->datos["page"] = "/reporte/reporte-reservas";
        $this->datos["js"] = ['rpt-reservas.js'];
        $this->datos["listaTiendas"] = $tiendas;
        $this->datos["tiendaUsuario"] = $tiendaUsuario;
        $this->datos["fechaDesde"] = $fechaDesde;
        $this->datos["fechaDesde"] = $fechaHasta;
        $this->load->view('init', $this->datos);
    }
    ...
    public function reporteSaldosPendientes() {
        ...
        $this->datos["page"] = "/reporte/reporte-saldos-pendientes";
        $this->datos["js"] = ['rpt-saldos-pend.js'];
        $this->datos["fechaDesde"] = $fechaDesde;
        $this->datos["fechaHasta"] = $fechaHasta;
        $this->datos["listaTiendas"] = $tiendas;
        $this->datos["tiendaUsuario"] = $tiendaUsuario;
    ...
    public function reportePrendas() {
        ...
        $this->datos["page"] = "/reporte/reporte-prendas";
        $this->datos["js"] = ['rpt-prendas.js'];
        $this->datos["fechaDesde"] = $fechaDesde;
        $this->datos["fechaHasta"] = $fechaHasta;
        $this->datos["listaTiendas"] = $tiendas;
        $this->datos["tiendaUsuario"] = $tiendaUsuario;
    ...
    public function reporteTopClientes() {
        ...
        $this->datos["page"] = "/reporte/reporte-top-clientes";
        $this->datos["js"] = ['rpt-top-clientes.js'];
        $this->datos["fechaDesde"] = $fechaDesde;
        $this->datos["fechaHasta"] = $fechaHasta;
        $this->datos["listaTiendas"] = $tiendas;
        $this->datos["tiendaUsuario"] = $tiendaUsuario;
    ...
    public function reporteTopProductos() {
        ...
        $this->datos["page"] = "/reporte/reporte-top-productos";
        $this->datos["js"] = ['rpt-top-productos.js'];
        $this->datos["fechaDesde"] = $fechaDesde;
        $this->datos["fechaHasta"] = $fechaHasta;
        $this->datos["categorias"] = $categorias;
        $this->datos["listaTiendas"] = $tiendas;
