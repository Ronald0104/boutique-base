...
class Admin_model extends CI_Model {
    ...
    function getInfoBasic($empresaId)
    {
        $this->db->select('empresaId, nombreComercial, tituloLogin, logoLogin');
    ...
    function check_login_generic($username) {
        $this->db->select('*'); 
        $this->db->where('usuario', $username); 
        $query = $this->db->get('tbl_usuario'); 
