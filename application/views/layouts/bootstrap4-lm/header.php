...
<head>
    ...
    <!-- <link rel="stylesheet" href="/assets/css/awesome-bootstrap-checkbox.min.css" type="text/css"> -->
    <link rel="stylesheet" href="/assets/css/custom-checkbox.min.css" type="text/css">
    <link rel="stylesheet" href="/assets/js/tableexport/css/tableexport.min.css">    
...
<body>  
    <!-- <?php echo "<pre>"?>
    <?php echo var_dump($usuarioSesion);?>
    <?php echo "</pre>"?> -->

    <?php 
        $usuarioSesion = $this->session->userdata('user')['nombre'] . " " .$this->session->userdata('user')['apellido_paterno'];

        if (!isset($empresa)) {
            $objEmpresa = new stdClass;
            $objEmpresa->nombreComercial = "Mi Boutique";
            $empresa= [0 => $objEmpresa];
        }
        $empresa = $empresa[0];
    ?>
    ...
    <div class="navbar navbar-expand-md navbar-dark fixed-top">
        <div class="navbar-brand">
            ...
            <h2 class="col-sm-10"><a href="<?php echo base_url();?>"> <?php echo $empresa->nombreComercial ?></a></h2>
            <a href="#" class="d-inline-block">
				<img src="/assets/img/logo-boutique-glamour.jpg" style="height: 35px;" alt="Mi Logo">
			</a>
            </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="<?php echo base_url() ?>login/logout" class="dropdown-item"><i class="icon-exit"></i> Salir</a>
                    </div>
                </li>
